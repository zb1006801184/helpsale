...
@interface MyGoodsThreeViewController ()
...
@implementation MyGoodsThreeViewController
...
- (void)getListData {
    ...
    [paramDic setObject:@"acution_success" forKey:@"status"];
